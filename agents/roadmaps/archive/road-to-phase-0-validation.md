...
- [x] **Step 3:** Bolt-on prototype — **the council's specific ask:** wire a hard-coded subset of agent-config (2 skills, 2 rules, 1 command) into Continue's existing Slash-Command system. Time-box 2 days. Measure: files touched, lines changed, tests broken, hours of "fighting the framework" vs "writing useful code." <!-- empirically replaced 2026-05-29 by validated-bet Phase 2 bolt-on (agents/analysis/validated-bet/bolt-on-real.md): 16 min wall-clock vs 2-day cap (60× under), +139/-1 LOC, tsc clean, 0 framework-fighting time, 5/5 artefacts surfaced at runtime. See validated-bet/verdict.md Phase 5 Step 2 re-activation note. -->
